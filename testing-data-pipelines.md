...
edit_link: https://github.com/edit/main/pages/notes/testing-data-pipelines.md
jinja: false
long_description: black flake8 interrogate mypy pipeline constructs pipeline as expected
  nodes pipeline has minimum nodes test minimum tags test alternate tags test catalog
  follows naming structure test function does the correct operations on test data
now: 2022-06-10 02:38:55.574704
path: pages/notes/testing-data-pipelines.md
slug: testing-data-pipelines
status: draft
super_description: black flake8 interrogate mypy pipeline constructs pipeline as expected
  nodes pipeline has minimum nodes test minimum tags test alternate tags test catalog
  follows naming structure test function does the correct operations on test data
tags:
- kedro
